 ...
 <script type="text/javascript">
   ...
   function initEcharts()
   {
	   ...
	   var createRandomItemStyle2 = function () {
		    var colorArr = ['#fda67e', '#81cacc', '#cca8ba', "#88cc81", "#82a0c5", '#fddb7e', '#735ba1','#00FFFF','#ADFF2F','#ADFF2F','#EE82EE','#FFA500','#FFB6C1','#FF69B4','#BA55D3','#B0E0E6','#800080'];

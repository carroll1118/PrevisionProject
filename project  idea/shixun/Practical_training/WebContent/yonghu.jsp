...
<!-- 侧边栏导航-->
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          <li class="active" id = 'content'> <a href="../page/yonghu.do"> <i class="icon-settings"></i>用户分析</a></li>
	    ...
	    <div class="resume-wrapper-inner mx-auto text-left bg-white shadow-lg">
		    <header class="resume-header pt-4 pt-md-0">
			   ...
			   <div> 
                 ...
                 <!-- body -->
                 <div id = "content" style="margin: 0 auto;display:block;"> 
					    ...
					    <div class="center">	
					       <div class="title mb-3">用户名：${s.username}</div>
						    ...
						    <ul class="list-unstyled">
				                ...
				                <li><a id="user_token" href="#">${s.user_token}</a></li>
						    </ul>
						 </div><!--//primary-info-->
					</div>
				</c:forEach> --%>
